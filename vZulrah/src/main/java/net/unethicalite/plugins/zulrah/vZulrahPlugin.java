...
import net.unethicalite.plugins.zulrah.framework.overlay.ZulrahStatsOverlay;
import net.unethicalite.plugins.zulrah.framework.overlay.ZulrahTileOverlay;
...
@Extension
@PluginDescriptor(name = "vZulrah", enabledByDefault = false)
@Slf4j
public class vZulrahPlugin extends TaskPlugin
{
    @Inject
    ...
    @Provides
    vZulrahConfig provideConfig(ConfigManager configManager)
    {
        return configManager.getConfig(vZulrahConfig.class);
    }
